...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterModule, RouterOutlet], template: '<!-- <div style="padding: 1rem">\n  <button mat-raised-button color="primary" routerLink="/travel">\n    Go to Travel Requests\n  </button>\n</div> -->\n\n<router-outlet></router-outlet>\n' }]
  }], null, null);
})();
(() => {
...
function LayoutComponent_ng_container_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const adminMenu_r2 = \u0275\u0275reference(2);
    \u0275\u0275advance(3);
...
var LayoutComponent = class _LayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LayoutComponent, selectors: [["app-layout"]], hostBindings: function LayoutComponent_HostBindings(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("ngIf", ctx.canCreateTravel || ctx.isBUHead || ctx.isCFO || ctx.isAdmin);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isBUHead || ctx.isAdmin);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isCFO || ctx.isAdmin);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isCFO || ctx.isAdmin);
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(ctx.userName);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.loggedInEmail);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.userRole);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.userFnumber);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.userMobile);
      \u0275\u0275advance(4);
...
var _c0 = (a0) => ({ error: a0 });
function LoginComponent_div_29_mat_spinner_1_Template(rf, ctx) {
  if (rf & 1) {
...
function LoginComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, LoginComponent_div_29_mat_spinner_1_Template, 1, 0, "mat-spinner", 15);
...
var LoginComponent = class _LoginComponent {
  ...
  constructor(fb, router, http, cdr, snackBar, config) {
    this.fb = fb;
    this.router = router;
    this.http = http;
    this.cdr = cdr;
  ...
  onSubmit() {
    if (this.loginForm.valid) {
      ...
      this.http.post(`${this.baseUrlCamp}/security/search-and-authenticate`, {
        fnumber,
        password
  ...
  start2FAPolling(authId) {
    ...
    const poll = () => {
      ...
      this.http.post(`${this.baseUrlCamp}/security/verify-2fa`, { authId }).subscribe({
        next: (res) => {
          if (this.hasLoggedIn || !this.isComponentAlive)
            return;
    ...
    this.pollingInterval = setInterval(poll, 2e3);
  }
  resetPollingState() {
    this.isPolling = false;
    this.loginForm.enable();
  ...
  static \u0275fac = function LoginComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LoginComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(HttpClient), \u0275\u0275directiveInject(ChangeDetectorRef), \u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(ConfigService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 30, vars: 3, consts: [[1, "login-wrapper"], [1, "login-left"], [1, "overlay-text"], [1, "login-right"], [1, "login-card"], [1, "version-label"], [1, "login-header"], ["src", "assets/images/fnb-logo.png", "alt", "Company Logo", 1, "login-logo"], [3, "ngSubmit", "formGroup"], ["appearance", "fill", 1, "full-width"], ["matInput", "", "type", "text", "formControlName", "fnumber", "required", ""], ["matInput", "", "type", "password", "formControlName", "password", "required", ""], ["mat-raised-button", "", "color", "primary", 1, "login-btn", 3, "disabled"], ["class", "polling-message", 3, "ngClass", 4, "ngIf"], [1, "polling-message", 3, "ngClass"], ["diameter", "24", 4, "ngIf"], [2, "margin-left", "10px"], ["diameter", "24"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h1");
      \u0275\u0275text(4, "Travel Request Management System");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p");
      \u0275\u0275text(6, "Book and manage your official travels seamlessly");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(7, "div", 3)(8, "mat-card", 4)(9, "div", 5);
      \u0275\u0275text(10, "v0.1.2");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "div", 6);
      \u0275\u0275element(12, "img", 7);
      \u0275\u0275elementStart(13, "div")(14, "mat-card-title");
      \u0275\u0275text(15, "Welcome Back");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "mat-card-subtitle");
      \u0275\u0275text(17, "Sign in with your f-number and password");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(18, "form", 8);
      ...
      \u0275\u0275text(28, " Sign In ");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(29, LoginComponent_div_29_Template, 4, 5, "div", 13);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(18);
...
var mergedConfig = mergeApplicationConfig(appConfig, runtimeConfig);
bootstrapApplication(AppComponent, mergedConfig).catch((err) => console.error("Bootstrap error:", err));
export {
  initializeApp
};
